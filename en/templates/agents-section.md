<!-- team-rules:start (managed by team-kickoff — this block is skill-managed; re-run the skill instead of hand-editing) -->
## Collaboration rules

- All changes go through a branch + PR. No direct pushes to {{DEFAULT_BRANCH}}{{PROTECTION_NOTE}}
